...
#Probability of packer hand wash5
...
Trhhp<-mcstoc(runif,type="VU",min=0.123,max=0.237)
...
Trphp<-mcstoc(runif,type="VU",min=0.123,max=0.237)
...
#dose calculation from LETTUCE ending with total virions/day
dose1lettuce <- (bodyweight*lettuceconsumpt*nvpP2decayl)/weightlettucehead
dose2lettuce <- (bodyweight*lettuceconsumpt*nvpP22decayl)/weightlettucehead
dose3lettuce <- (bodyweight*lettuceconsumpt*nvpP23decayl)/weightlettucehead
dose4lettuce <- (bodyweight*lettuceconsumpt*nvpP24decayl)/weightlettucehead
dose5lettuce <- (bodyweight*lettuceconsumpt*nvpP25decayl)/weightlettucehead
dose6lettuce <- (bodyweight*lettuceconsumpt*nvpP26decayl)/weightlettucehead
dose7lettuce <- (bodyweight*lettuceconsumpt*nvpP27decayl)/weightlettucehead
dose8lettuce <- (bodyweight*lettuceconsumpt*nvpP28decayl)/weightlettucehead
dose9lettuce <- (bodyweight*lettuceconsumpt*nvpP29decayl)/weightlettucehead
dose10lettuce <- (bodyweight*lettuceconsumpt*nvpP210decayl)/weightlettucehead

#calculating risk from LETTUCE with fractional Poisson model aggregated viral decay at 5C

riskfracpoissa1 <- P*(1-exp(-dose1lettuce/mu))
riskfracpoissa2 <- P*(1-exp(-dose2lettuce/mu))
riskfracpoissa3 <- P*(1-exp(-dose3lettuce/mu))
riskfracpoissa4 <- P*(1-exp(-dose4lettuce/mu))
riskfracpoissa5 <- P*(1-exp(-dose5lettuce/mu))
riskfracpoissa6 <- P*(1-exp(-dose6lettuce/mu))
riskfracpoissa7 <- P*(1-exp(-dose7lettuce/mu))
riskfracpoissa8 <- P*(1-exp(-dose8lettuce/mu))
riskfracpoissa9 <- P*(1-exp(-dose9lettuce/mu))
riskfracpoissa10 <- P*(1-exp(-dose10lettuce/mu))

###putting everything through the mc function
#sensitivity for risk lettuce
QMRAlettuce<-mc(conc,fh,hweff, Phhw,Phwg, prevh, concp, fhp, hweffp, Pphw, Ppwg, prevp, Trhhp, Trhgp,Trpph,Trphp,Trpgp, P, mu,
              ...
              dose1lettuce,dose2lettuce,dose3lettuce,dose4lettuce, dose5lettuce, dose6lettuce, dose7lettuce,dose8lettuce, dose9lettuce, dose10lettuce,
              riskfracpoissa2,riskfracpoissa3,riskfracpoissa4,riskfracpoissa5,riskfracpoissa6,riskfracpoissa7,riskfracpoissa8,riskfracpoissa9, riskfracpoissa10,
              riskfracpoissa1)
summary(QMRAlettuce)
summary(QMRAlettuce$riskfracpoissa1)
summary(QMRAlettuce$nvpP2)

torlettuce<-tornado(QMRAlettuce)
plot(torlettuce)
print(torlettuce)
mcratio(QMRAlettuce)
unclettuce=tornadounc(QMRAlettuce)
unclettuce
####################################################################################################################################################################################################################################################################
