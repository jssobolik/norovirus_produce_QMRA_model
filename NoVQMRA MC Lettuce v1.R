...
QMRAlettuce<-mc(conc,fh,hweff, Phhw,Phwg, prevh, concp, fhp, hweffp, Pphw, Ppwg, prevp, Trhhp, Trhgp,Trpph,Trphp,Trpgp, P, mu,
              ...
              nvBi,nvhP2,nvPPBi,nvhP3,nvBe,nvpP1,nvpH1, nvpP2decayl, weightlettucehead, weightmelon, weighttomato, weightberry, lettuceconsumpt,melonconsumpt, tomatoconsumpt, berryconsumpt, 
              dose1lettuce,riskfracpoissa1, nvpP2)
summary(QMRAlettuce$riskfracpoissa1)
summary(QMRAlettuce$nvpP2)
summary(QMRAlettuce$nvhH)
summary(QMRAlettuce$nvpH)
