...
prevh<-mcstoc(rempiricalD,type="V",values=c(1,0),prob=c(0.04,0.96))
...
#Norovirus prevalence among people without gastroenteritis 
prevp<-mcstoc(rempiricalD,type="V",values=c(1,0),prob=c(0.04,0.96))
...
QMRAtomato<-mc(conc,fh,hweff, Phhw,Phwg, prevh, concp, fhp, hweffp, Pphw, Ppwg, prevp, Trhhp, Trhgp,Trpph,Trphp,Trpgp, P, mu,
              ...
              nvBi,nvhP2,nvPPBi,nvhP3,nvBe,nvpP1,nvpH1,nvpP2, nvpP2decayl, weightlettucehead, weightmelon, weighttomato, weightberry, lettuceconsumpt,melonconsumpt, tomatoconsumpt, berryconsumpt, 
              dose1tomato,riskfracpoissT1)
